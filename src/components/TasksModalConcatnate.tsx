...
export const TasksModalConcatnate = ({ onClose }: TasksModalProps) => {
            ...
            <div className="space-y-2">
              {tasks.length === 0 ? (
                ...
                <>
                  ...
                  >
                    {selectedTaskIds.size === useMemo(() => tasks.filter(t => !existingGoogleTaskIds.has(t.googleTaskId)), []).length ? (
                  ...
                  {tasks.map(task => {
                    ...
                    return (
                      <button
                        ...
                        className={`p-3 rounded-xl border flex items-start gap-3 transition-all ${isImported
